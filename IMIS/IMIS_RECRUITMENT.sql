...
CREATE TABLE `RECRUITMENT` (
  ...
  KEY `JOB_NUM` (`JOB_NUM`),
  CONSTRAINT `recruitment_ibfk_1` FOREIGN KEY (`COMPANY_NUM`) REFERENCES `COMPANY` (`COMPANY_NUM`),
  CONSTRAINT `recruitment_ibfk_2` FOREIGN KEY (`JOB_NUM`) REFERENCES `JOBS` (`JOB_NUM`)
