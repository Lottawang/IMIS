...
CREATE TABLE `INTERNSHIP_TYPE` (
  ...
  `TYPE_DESCRIPTION` varchar(90) NOT NULL,
...
LOCK TABLES `INTERNSHIP_TYPE` WRITE;
/*!40000 ALTER TABLE `INTERNSHIP_TYPE` DISABLE KEYS */;
/*!40000 ALTER TABLE `INTERNSHIP_TYPE` ENABLE KEYS */;
UNLOCK TABLES;
