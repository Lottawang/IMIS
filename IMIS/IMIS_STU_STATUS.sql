...
CREATE TABLE `STU_STATUS` (
  `STU_STATUS-NUM` int(11) NOT NULL,
  `STU_STATUS_DESCRIPTION` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`STU_STATUS-NUM`)
...
INSERT INTO `STU_STATUS` VALUES (1,'International'),(2,'Permanent Resident'),(3,'Citizen');
