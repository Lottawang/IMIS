...
CREATE TABLE `WORKRECORD` (
  ...
  PRIMARY KEY (`STU_ID`,`EXPERIENCE_NUM`),
  KEY `EXPERIENCE_NUM_idx` (`EXPERIENCE_NUM`),
  CONSTRAINT `workrecord_ibfk_1` FOREIGN KEY (`STU_ID`) REFERENCES `STUDENTS` (`STU_ID`),
  CONSTRAINT `workrecord_ibfk_2` FOREIGN KEY (`EXPERIENCE_NUM`) REFERENCES `WORK_EXPERIENCE` (`EXPERIENCE_NUM`)
